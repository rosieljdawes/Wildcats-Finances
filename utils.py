...
def model_2024(fixed_variables, modifiable_variables, random_variables, dropoff_rates):
    ...
    sem_1_ice_fee_paying_members = (
        ...
        * random_variables["Number of members"]
    )
    ...
    money_out = (
        ...
        * (
            modifiable_variables["Number of training sessions"]
            + modifiable_variables["Number of beginners sessions"]
        )
        + fixed_variables["Number of matches per team"]
        * modifiable_variables["Number of teams"]
        * (fixed_variables["Ref hire"] + 2 * fixed_variables["Ice hire"] + fixed_variables["Match beers"])
